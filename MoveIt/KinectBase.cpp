 ...
 * KinectBase.cpp
 *
 * This code is based on Kinect for Windows Developer Toolkit
 * Skeleton Basics D2D code sampe.
 *
 */
...
/// <param name="hInstance">handle to the application instance</param>
/// <param name="nCmdShow">whether to display minimized, maximized, or normally</param>
int KinectBase::Run(HINSTANCE hInstance, int nCmdShow)
{
    MSG       msg = {0};
    WNDCLASS  wc  = {0};
    ...
    HWND hWndApp = CreateDialogParamW(
        ...
        NULL,
        (DLGPROC)KinectBase::MessageRouter, 
...
LRESULT CALLBACK KinectBase::MessageRouter(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    KinectBase* pThis = NULL;
    
    if (WM_INITDIALOG == uMsg)
    {
        pThis = reinterpret_cast<KinectBase*>(lParam);
        SetWindowLongPtr(hWnd, GWLP_USERDATA, reinterpret_cast<LONG_PTR>(pThis));
    }
    else
    {
        pThis = reinterpret_cast<KinectBase*>(::GetWindowLongPtr(hWnd, GWLP_USERDATA));
    }
...
/// <param name="lParam">additional message data</param>
/// <returns>result of message processing</returns>
LRESULT CALLBACK KinectBase::DlgProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    switch (message)
    {
        case WM_INITDIALOG:
...
HRESULT KinectBase::CreateFirstConnected()
{
...
/// </summary>
void KinectBase::ProcessSkeleton()
{
...
void KinectBase::DrawBone(const NUI_SKELETON_DATA & skel, NUI_SKELETON_POSITION_INDEX joint0, NUI_SKELETON_POSITION_INDEX joint1)
{
...
HRESULT KinectBase::EnsureDirect2DResources()
{
    HRESULT hr = S_OK;
...
/// </summary>
void KinectBase::DiscardDirect2DResources( )
{
...
void KinectBase::SetStatusMessage(WCHAR * szMessage)
{
